          ...
          {SERVICIOS.map((s) => (
            ...
            >
              ...
              <button
                ...
                className="mt-auto inline-flex items-center justify-center gap-1.5 rounded-full bg-[var(--color-brand-terracotta)] px-5 py-3 pt-3 text-sm font-semibold text-white shadow-sm transition-all duration-300 hover:bg-[var(--color-brand-clay)] hover:shadow-md"
